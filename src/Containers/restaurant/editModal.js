...
const {visible, setVisible, idItem} = props
...
const okHandler = () => {
    ...
    props.restaurantActions.editRestaurant({...formdata, image, kitchens, idItem});
...
return (
    ...
    >
        ...
        >
            ...
            >
                <Input name= "amountOfPlace" value={formdata.amountOfPlace}  onChange={onChange} />
            </Form.Item>
            <Form.Item
                label="Средний чек"
                rules={[
            ...
            >
                <Input name="averageBill" value={formdata.averageBill}  onChange={onChange} />
            </Form.Item>
            <Form.Item
                label="Кухня"
                rules={[
